...
public class ForgotPasswordPanel extends JPanel {
    ...
    private void requestResetCode() {
        ...
        if ("OK".equals(status)) {
            ...
            if ("00".equals(responseCode) && !resetCode.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Mã xác nhận đã được gửi đến email ", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
        }
    ...
    private void resetPassword() {
        ...
        if (error != null) {
            ...
            JOptionPane.showMessageDialog(this,"Đặt lại mật khẩu thành công!" , "Lỗi", JOptionPane.INFORMATION_MESSAGE);
        }
    }
